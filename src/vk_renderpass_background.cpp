...
void BackgroundPass::execute(VkCommandBuffer cmd)
{
    ...
    vkutil::transition_image(cmd, _engine->_drawImage.image, VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL,
    ...
    dispatchInfo.bindings.push_back(ComputeBinding::storeImage(0, _engine->_drawImage.imageView));
